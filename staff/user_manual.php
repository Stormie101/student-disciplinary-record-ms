  ...
  const manualSections = {
    ...
    'report-case-btn': {
      ...
      content: `
        ...
        <ul>
          <li><strong>Type of Offense:</strong> Select the category that best fits the incident from the dropdown list (e.g., Inappropriate Attire, Disruptive Behavior, Cheating).</li>
